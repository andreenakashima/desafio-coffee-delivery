...
export function Card() {
	return (
		<li className="m-auto w-64 rounded-md rounded-tr-[36px] rounded-bl-[36px] bg-base-card p-4 text-center">
			<img className="m-auto" src="./products-img/expresso.png" alt="" />
